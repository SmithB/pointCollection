...
class data(pc.data):
    ...
    def cryosat_baseline_AB(self, fid, n_records):
        ...
        CS_l2_mds['Data_20Hz']['Elev'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['SSHA_interp'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['SSHA_interp_count'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['SSHA_interp_RMS'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Sig0'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        # Peakiness: packed units (1e-2)
        CS_l2_mds['Data_20Hz']['Peakiness'] = np.ma.zeros((n_records,n_blocks),dtype=np.uint16)
        CS_l2_mds['Data_20Hz']['Peakiness'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Freeboard'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        # Number of averaged echoes or beams
        CS_l2_mds['Data_20Hz']['N_avg'] = np.ma.zeros((n_records,n_blocks),dtype=np.int16)
        CS_l2_mds['Data_20Hz']['N_avg'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        CS_l2_mds['Data_20Hz']['Spare1'] = np.ma.zeros((n_records,n_blocks),dtype=np.int16)
        CS_l2_mds['Data_20Hz']['Spare1'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        # Quality flags
        CS_l2_mds['Data_20Hz']['Quality_flag'] = np.ma.zeros((n_records,n_blocks),dtype=np.uint32)
        CS_l2_mds['Data_20Hz']['Quality_flag'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        CS_l2_mds['Data_20Hz']['Spare2'] = np.ma.zeros((n_records,n_blocks),dtype=np.int16)
        CS_l2_mds['Data_20Hz']['Spare2'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        CS_l2_mds['Data_20Hz']['Spare3'] = np.ma.zeros((n_records,n_blocks),dtype=np.int16)
        CS_l2_mds['Data_20Hz']['Spare3'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        CS_l2_mds['Data_20Hz']['Spare4'] = np.ma.zeros((n_records,n_blocks),dtype=np.int16)
        CS_l2_mds['Data_20Hz']['Spare4'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        CS_l2_mds['Data_20Hz']['Spare5'] = np.ma.zeros((n_records,n_blocks),dtype=np.int16)
        CS_l2_mds['Data_20Hz']['Spare5'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
    ...
    def cryosat_baseline_C(self, fid, n_records):
        ...
        CS_l2_mds['Data_20Hz']['Elev_1'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Elev_2'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Elev_3'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Sig0_1'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Sig0_2'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Sig0_3'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
        # Freeboard: packed units (mm, 1e-3 m)
        # -9999 default value indicates computation has not been performed
        CS_l2_mds['Data_20Hz']['Freeboard'] = np.ma.zeros((n_records,n_blocks),dtype=np.int16)
        CS_l2_mds['Data_20Hz']['Freeboard'].mask = np.ones((n_records,n_blocks),dtype=np.bool)
    ...
    def cryosat_baseline_D(self, full_filename, unpack=False):
        ...
        # add ascending/descending flag to 1Hz data (A=ascending,D=descending)
        CS_l2_mds['Data_1Hz']['Ascending_flag'] = np.zeros((n_records),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Time'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        time_20_ku = fid.variables['time_20_ku'][:].copy()
        # Delta between the timestamps for 20Hz record and the 1Hz record
        # D_time_mics packed units (microseconds)
        CS_l2_mds['Data_20Hz']['D_time_mics'] = np.ma.zeros((n_records,n_blocks))
        CS_l2_mds['Data_20Hz']['D_time_mics'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        # Lat: packed units
        CS_l2_mds['Data_20Hz']['Lat'] = np.ma.zeros((n_records,n_blocks))
        CS_l2_mds['Data_20Hz']['Lat'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        lat_poca_20_ku = fid.variables['lat_poca_20_ku'][:].copy()
        # Lon: packed units
        CS_l2_mds['Data_20Hz']['Lon'] = np.ma.zeros((n_records,n_blocks))
        CS_l2_mds['Data_20Hz']['Lon'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Elev_1'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Elev_2'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Elev_3'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Sig0_1'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Sig0_2'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Sig0_3'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Range_1'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Range_2'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Range_3'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        range_3_20_ku = fid.variables['range_3_20_ku'][:].copy()
        # Freeboard
        CS_l2_mds['Data_20Hz']['Freeboard'] = np.ma.zeros((n_records,n_blocks))
        CS_l2_mds['Data_20Hz']['Freeboard'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        freeboard_20_ku = fid.variables['freeboard_20_ku'][:].copy()
        # Sea ice Floe height
        CS_l2_mds['Data_20Hz']['Sea_Ice_Lead'] = np.ma.zeros((n_records,n_blocks))
        CS_l2_mds['Data_20Hz']['Sea_Ice_Lead'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Sea_Ice_Floe'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['SSHA_interp'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['SSHA_interp_count'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['SSHA_interp_RMS'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Peakiness'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        peakiness_20_ku = fid.variables['peakiness_20_ku'][:].copy()
        # Number of averaged echoes or beams
        CS_l2_mds['Data_20Hz']['N_avg'] = np.ma.zeros((n_records,n_blocks))
        CS_l2_mds['Data_20Hz']['N_avg'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Quality_flag'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Corrections_flag'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Measurement_Mode'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Surf_type'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        surf_type_20_ku = fid.variables['surf_type_20_ku'][:].copy()
        # Quality metric for retracker 1
        CS_l2_mds['Data_20Hz']['Quality_1'] = np.ma.zeros((n_records,n_blocks))
        CS_l2_mds['Data_20Hz']['Quality_1'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Quality_2'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
        ...
        CS_l2_mds['Data_20Hz']['Quality_3'].mask = np.ma.ones((n_records,n_blocks),dtype=np.bool)
